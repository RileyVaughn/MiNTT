...
SIMD128_64 = MiNTT128_simd_int64/MiNTT128_simd_int64.o
...
main: main.cpp $(UTIL) $(NORM64_64) $(SIMD64_64) $(NORM128_64) $(SIMD128_64)
	g++ main.cpp $(UTIL) $(NORM64_64) $(SIMD64_64) $(NORM128_64) $(SIMD128_64) -o main $(INCLUDES) $(CFLAGS)
...
$(SIMD128_64): MiNTT128_simd_int64/MiNTT128_simd_int64.cpp
	g++ -c MiNTT128_simd_int64/MiNTT128_simd_int64.cpp -o $(SIMD128_64) $(INCLUDES) $(CFLAGS)


clean:
	rm -f main $(UTIL) $(NORM64_64) $(SIMD64_64) $(NORM128_64) $(SIMD128_64)
