...
main: main.cpp $(UTIL64).o $(UTIL16).o $(NORM64_64).o $(SIMD64_64).o $(NORM128_64).o $(SIMD128_64).o $(NORM64_16).o $(SIMD64_16).o $(NORM128_16).o $(SIMD128_16).o $(NORM8_16).o $(SIMD8_16).o $(NORM128_64_QF4).o
	g++ main.cpp $(UTIL64).o $(UTIL16).o $(NORM64_64).o $(SIMD64_64).o $(NORM128_64).o $(SIMD128_64).o  $(NORM64_16).o $(SIMD64_16).o $(NORM128_16).o $(SIMD128_16).o $(NORM8_16).o $(SIMD8_16).o $(NORM128_64_QF4).o -o main $(INCLUDES) $(CFLAGS)
...
clean:
	rm -f main $(UTIL64).o $(UTIL16).o $(NORM64_64).o $(SIMD64_64).o $(NORM128_64).o $(SIMD128_64).o $(NORM64_16).o $(SIMD64_16).o $(NORM128_16).o $(SIMD128_16).o $(NORM8_16).o $(SIMD8_16).o $(NORM128_64_QF4).o
