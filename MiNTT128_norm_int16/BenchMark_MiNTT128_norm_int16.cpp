...
BenchMark_MiNTT128_norm_int16::BenchMark_MiNTT128_norm_int16(){
    Setup();
}

void BenchMark_MiNTT128_norm_int16::Setup(){
...
void BenchMark_MiNTT128_norm_int16::Hash(uint8_t input[INPUT_SIZE],uint8_t out[OUTPUT_SIZE]){
...
void BenchMark_MiNTT128_norm_int16::PrintKey(std::string filename){
...
void BenchMark_MiNTT128_norm_int16::ncc(uint8_t input[ndiv8], int16_t intermed[ndiv8][8]){
...
void BenchMark_MiNTT128_norm_int16::ntt_sum(uint8_t input[INPUT_SIZE], int16_t out[d][ndiv8][8]){
...
void BenchMark_MiNTT128_norm_int16::change_base(int16_t val[d][ndiv8][8], uint8_t out[OUTPUT_SIZE]){
...
void BenchMark_MiNTT128_norm_int16::PrintBenchMark(){
