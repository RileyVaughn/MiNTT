...
MiNTT128_SIMD_int64::MiNTT128_SIMD_int64(){
    Setup();
}

void MiNTT128_SIMD_int64::Setup(){
...
void MiNTT128_SIMD_int64::PrintKey(std::string filename){
...
void MiNTT128_SIMD_int64::ncc(uint8_t input[ndiv8], int64_t intermed[ndiv8][8]){
...
void MiNTT128_SIMD_int64::ntt_sum(uint8_t input[INPUT_SIZE], int64_t out[d][ndiv8][8]){
...
void MiNTT128_SIMD_int64::change_base(int64_t val[d][ndiv8][8], uint8_t out[OUTPUT_SIZE]){
