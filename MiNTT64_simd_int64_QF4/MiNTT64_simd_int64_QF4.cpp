...
MiNTT64_SIMD_int64_QF4::MiNTT64_SIMD_int64_QF4(){
    Setup();
}

void MiNTT64_SIMD_int64_QF4::Setup(){
...
void MiNTT64_SIMD_int64_QF4::Hash(uint8_t input[INPUT_SIZE_QF4],uint8_t out[OUTPUT_SIZE_QF4]){
...
void MiNTT64_SIMD_int64_QF4::ncc(uint8_t input[ndiv8], int64_t intermed[ndiv8][8]){
...
void MiNTT64_SIMD_int64_QF4::ntt_sum(uint8_t input[INPUT_SIZE_QF4], int64_t out[d][ndiv8][8]){
...
void MiNTT64_SIMD_int64_QF4::change_base(int64_t val[d][ndiv8][8], uint8_t out[OUTPUT_SIZE_QF4]){
